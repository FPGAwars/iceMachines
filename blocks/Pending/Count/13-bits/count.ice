{
  ...
  "package": {
    "name": "count-13bits",
    "version": "0.2",
    "description": "Máquina de contar, de 13 bits",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "46573fcd-2d82-44d4-9994-e8095f3560fd",
          "type": "basic.inputLabel",
          "data": {
            "name": "cnt",
            "range": "[12:0]",
        ...
        {
          "id": "40e863f8-8079-4c3f-a5b9-7ad0f426cec1",
          "type": "basic.outputLabel",
          "data": {
            "name": "cnt",
            "range": "[12:0]",
        ...
        {
          "id": "08389c77-e16f-4530-aef9-564199a4aa67",
          "type": "basic.output",
          "data": {
            "name": "n",
            "range": "[12:0]",
        ...
        {
          "id": "5163fa32-c479-414e-b19d-d6612fa4e172",
          "type": "basic.outputLabel",
          "data": {
            "name": "cnt",
            "range": "[12:0]",
        ...
        {
          "id": "7ef48c30-d197-4686-bd80-58c73b38acf3",
          "type": "basic.outputLabel",
          "data": {
            "name": "cnt",
            "range": "[12:0]",
        ...
        {
          "id": "80d58a91-8dbe-4bf4-8a0e-5e2435c27f04",
          "type": "0ae40eda8a03e722dca2c6a2418ec7d88a6667a9",
          "position": {
            "x": 1352,
            "y": -104
          },
        ...
        {
          "id": "7db31366-87fd-4339-8b85-6a85dd845bbd",
          "type": "9953622fccf2482d86067f450ae5bcb0247d8acd",
          "position": {
            "x": 856,
            "y": 512
          },
        ...
        {
          "id": "f1f018d0-cbec-496e-b306-bb77e24ae87d",
          "type": "38ba744f4d5a7be09445ef762ebd3a2ffc1443b1",
          "position": {
            "x": 680,
            "y": 448
          },
        ...
        {
          "id": "dd16bde5-1b84-4146-b174-d5bb2d232214",
        ...
        {
          "id": "26f99f59-0cd5-4d84-8ddb-b53d5407faf3",
        ...
        {
          "id": "dc0d6d2d-59ca-43f7-a533-73273db89a8c",
          "type": "3e6c0bdc5965b4e6ea24bd3a6b4ef6f92096c3ed",
          "position": {
            "x": 1648,
            "y": -152
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "dc0d6d2d-59ca-43f7-a533-73273db89a8c",
        ...
        {
          "source": {
            "block": "dd16bde5-1b84-4146-b174-d5bb2d232214",
        ...
        },
        {
          ...
          "target": {
            "block": "26f99f59-0cd5-4d84-8ddb-b53d5407faf3",
        ...
        {
          "source": {
            "block": "5163fa32-c479-414e-b19d-d6612fa4e172",
            "port": "outlabel"
          },
          "target": {
            "block": "08389c77-e16f-4530-aef9-564199a4aa67",
            "port": "in",
            "size": 13
          },
          "size": 13
        },
        {
          ...
          "target": {
            "block": "46573fcd-2d82-44d4-9994-e8095f3560fd",
            "port": "inlabel"
          },
          "size": 13
        },
        {
          "source": {
            "block": "40e863f8-8079-4c3f-a5b9-7ad0f426cec1",
            "port": "outlabel"
          },
          "target": {
            "block": "80d58a91-8dbe-4bf4-8a0e-5e2435c27f04",
            "port": "2aac3a80-c58c-4e45-929c-e20555696d32",
            "size": 13
          },
          "size": 13
        },
        {
          "source": {
            "block": "7ef48c30-d197-4686-bd80-58c73b38acf3",
            "port": "outlabel"
          },
          "target": {
            "block": "7db31366-87fd-4339-8b85-6a85dd845bbd",
            "port": "d11d9673-36f1-4fcd-8291-9a70cca9023c",
            "size": 13
          },
          "size": 13
        },
        ...
        },
        {
          ...
          "target": {
            "block": "f1f018d0-cbec-496e-b306-bb77e24ae87d",
        ...
        },
        {
          "source": {
            "block": "80d58a91-8dbe-4bf4-8a0e-5e2435c27f04",
            "port": "43502c8c-1d3d-49a3-b7ff-df8a8f2742a8"
          },
          "target": {
            "block": "dc0d6d2d-59ca-43f7-a533-73273db89a8c",
        ...
        },
        {
          "source": {
            "block": "f1f018d0-cbec-496e-b306-bb77e24ae87d",
            "port": "f34aa26c-9423-4587-9948-9b2a583309b0"
          },
          "target": {
            "block": "7db31366-87fd-4339-8b85-6a85dd845bbd",
            "port": "fdef2961-fe99-4e83-86e7-341d3d832111"
          },
          "size": 13
        }
      ]
  ...
  "dependencies": {
    ...
    "0ae40eda8a03e722dca2c6a2418ec7d88a6667a9": {
      "package": {
        "name": "sum-1op-13bits",
        "version": "0.1",
    ...
    "9953622fccf2482d86067f450ae5bcb0247d8acd": {
      "package": {
        "name": "Comp-2op-13-bits",
        "version": "0.1",
        "description": "Comparador de dos operandos de 13 bits",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "fdef2961-fe99-4e83-86e7-341d3d832111",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[12:0]",
            ...
            {
              "id": "d11d9673-36f1-4fcd-8291-9a70cca9023c",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[12:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "fdef2961-fe99-4e83-86e7-341d3d832111",
                "port": "out"
              },
              "target": {
                "block": "9c811723-c900-4ceb-9989-036b071ee3fe",
            ...
            {
              "source": {
                "block": "d11d9673-36f1-4fcd-8291-9a70cca9023c",
                "port": "out"
              },
              "target": {
                "block": "9c811723-c900-4ceb-9989-036b071ee3fe",
    ...
    "38ba744f4d5a7be09445ef762ebd3a2ffc1443b1": {
      "package": {
        "name": "Constante-13bits",
        "version": "0.0.1-c1599934848521",
        "description": "Valor genérico constante (menos 1), de 13 bits. Su valor se introduce como parámetro. Por defecto vale 0",
        "author": "Juan Gonzalez-Gomez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "f34aa26c-9423-4587-9948-9b2a583309b0",
              "type": "basic.output",
              "data": {
                "name": "k",
                "range": "[12:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "f34aa26c-9423-4587-9948-9b2a583309b0",
                "port": "in"
              },
              "size": 13
            }
    ...
    "3e6c0bdc5965b4e6ea24bd3a6b4ef6f92096c3ed": {
      "package": {
        "name": "13-Reg-rst",
        "version": "0.8",
